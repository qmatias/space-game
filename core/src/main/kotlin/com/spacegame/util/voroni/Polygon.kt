...
import com.spacegame.util.voroni.Point
...
data class Polygon(var coordinates: ArrayList<Double> = ArrayList()) {
    ...
    companion object {
         ...
         * for each of the polygon points [x1,y1, x2,y2, x3,y3, ...].
         * @param coordinates array with coordinates of the polygon points
         * @param point point object that will receive the center position, that way there is no need to create new Point object each time
         */
        fun center(coordinates: ArrayList<Double>, point: Point? = null): Point {
         ...
         * @param coordinates array with coordinates of the polygon points
         */
        fun bound(coordinates: ArrayList<Double>): Rectangle {
            ...
            return Rectangle(left, top, rights, bottom)
        }
    }
}